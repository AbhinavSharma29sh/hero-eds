export default function decorate(block) {
  ...
  // Create the calculator structure
      ...
      <div class="emi-right">
        <div class="emi-result-card">
          ...
          <div class="emi-bike-container">
            <img src="https://bd.gaadicdn.com/processedimages/hero/splendor-plus/source/splendor-plus6409d99be0173.jpg" alt="Hero Bike" class="emi-bike-img"/>
          </div>
        </div>
      </div>
    </div>
